                ...
                <div class="container">
                        ...
                        <li>
                            <div class="product-card">
                                <div class="card-banner img-holder" style="--width: 360; --height: 360">
                                    <img src="./assets/images/pettoy1.jpg" width="360" height="360" loading="lazy" alt="Commodo leo sed porta" class="img-cover default" />
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">Meat Up Non-Toxic Rubber Dog Chew Bone Toy, Puppy/Dog Teething Toy (Medium) - 12.7 cm</a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit....
                                    </p>

                                    <data class="card-price" value="15">Rs 142.00</data>
                    ...
                    location.href='http://localhost/TE_IT/payment.php'
                        ...
                        <li>
                            <div class="product-card">
                                <div class="card-banner img-holder" style="--width: 360; --height: 360">
                                    <img src=".\assets\images\Pettoy2.jpg" width="360" height="360" loading="lazy" alt="Purus consequat congue sit" class="img-cover default" />
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">The Dogs Company The Pets Company Natural Rubber Spiked Ball Dog Chew Toy, Puppy Teething Toy, 3 Inches </a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit....
                                    </p>

                                    <data class="card-price" value="45">Rs 200.00</data>
                                    <form method="post"><button class="btn_buy" name="buy">buy now</button></form>
                                    <?php
                                    if (isset($_POST["buy"])) {
                                        echo "<script>
                    location.href='http://localhost/TE_IT/payment.php'
                        ...
                        <li>
                            <div class="product-card">
                                <div class="card-banner img-holder" style="--width: 360; --height: 360">
                                    <img src=".\assets\images\Pettoy3.jpg" width="360" height="360" loading="lazy" alt="Morbi vel arcu scelerisque" class="img-cover default" />
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title"> Foodie Puppies Natural Latex Rubber Squeaky Chew Toy - (Purple Elephant), Suitable for Puppy, X-Small to Small Dogs (0-10kgs)</a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit....
                                    </p>

                                    <data class="card-price" value="45">Rs 342.00</data>
                                    <form method="post"><button class="btn_buy" name="buy">buy now</button></form>
                                    <?php
                                    if (isset($_POST["buy"])) {
                                        echo "<script>
                    location.href='http://localhost/TE_IT/payment.php'
                        ...
                        <li>
                            <div class="product-card">
                                <div class="card-banner img-holder" style="--width: 360; --height: 360">
                                    <img src=".\assets\images\Pettoy4.jpg" width="360" height="360" loading="lazy" alt="Morbi vel arcu scelerisque" class="img-cover default" />
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">GREENBIRDS 8 Pcs Combo of Bird Toys Wooden Colorfull Bird Ladder, Swing, Bird Perches for Budgies, Love Birds</a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit....
                                    </p>

                                    <data class="card-price" value="49">Rs 709.00</data>
                                    <form method="post"><button class="btn_buy" name="buy">buy now</button></form>
                                    <?php
                                    if (isset($_POST["buy"])) {
                                        echo "<script>
                ...
                <div class="container">
                    ...
                    <ul class="grid-list">
                        <li>
                            <div class="product-card">
                                <div class="card-banner img-holder" style="--width: 360; --height: 360">
                                    <img src=".\assets\images\Pettoy5.jpg" width="360" height="360" loading="lazy" alt="Morbi vel arcu scelerisque" class="img-cover default" />
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">Futurekart Parrot Bird Toys Natural Colorful Rope Bungee Climbing Ropes Swing Chewing Toys - Lengh 1m</a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit....
                                    </p>

                                    <data class="card-price" value="85">Rs 534.00</data>
                                    <form method="post"><button class="btn_buy" name="buy">buy now</button></form>
                                    <?php
                                    if (isset($_POST["buy"])) {
                                        echo "<script>
                    location.href='http://localhost/TE_IT/payment.php'
                        ...
                        <li>
                            <div class="product-card">
                                <div class="card-banner img-holder" style="--width: 360; --height: 360">
                                    <img src=".\assets\images\Pettoy6.jpg" width="360" height="360" loading="lazy" alt="Nam justo libero porta ege" class="img-cover default" />
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">The Pets Company Catch The Mouse & Ball Cat Toy, Interactive, Training, Activity Toy for Cats & Kittens</a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit....
                                    </p>

                                    <data class="card-price" value="85">Rs 450.00</data>
                                    <form method="post"><button class="btn_buy" name="buy">buy now</button></form>
                                    <?php
                                    if (isset($_POST["buy"])) {
                                        echo "<script>
                    location.href='http://localhost/TE_IT/payment.php'
                        ...
                        <li>
                            <div class="product-card">
                                <div class="card-banner img-holder" style="--width: 360; --height: 360">
                                    <img src=".\assets\images\Pettoy7.jpg" width="360" height="360" loading="lazy" alt="Nam justo libero porta ege" class="img-cover default" />
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">Foodie Puppies Cat Teaser Playing Stick & Feather Interactive Teasing Wand Toy (Mouse-Bell)</a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit....
                                    </p>
                                    <data class="card-price" value="85">Rs 117.00</data>
                                    <form method="post"><button class="btn_buy" name="buy">buy now</button></form>
                                    <?php
                                    if (isset($_POST["buy"])) {
                                        echo "<script>
                    location.href='http://localhost/TE_IT/payment.php'
                        ...
                        <li>
                            <div class="product-card">
                                <div class="card-banner img-holder" style="--width: 360; --height: 360">
                                    <img src=".\assets\images\Pettoy8.jpg" width="360" height="360" loading="lazy" alt="Etiam commodo leo sed" class="img-cover default" />
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">PETS EMPIRE Fun Interactive Plush Cat, Kitten Playing Toy Color May Very (3 Piece)</a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit....
                                    </p>

                                    <data class="card-price" value="55">Rs 176.00</data>
                                    <form method="post"><button class="btn_buy" name="buy">buy now</button></form>
                                    <?php
                                    if (isset($_POST["buy"])) {
                                        echo "<script>
